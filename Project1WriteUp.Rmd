...
( You can do it for different time scales during an hour, during a day or during the entire experiment). However, at least the plots with days as x-axis are required. As justified before, I used epoch as the x variable for time here. We could also use result_time.)
